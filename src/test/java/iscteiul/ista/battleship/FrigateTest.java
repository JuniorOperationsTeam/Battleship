...
class FrigateTest {
    ...
    @Nested
    @DisplayName("Testes de Extremos da Fragata")
    class ExtremesTests {
        ...
        void getTopBottomMostPos() {
            ...
            if (top instanceof Position) {
                ...
                fail("Tipo inesperado: " + (top == null ? "null" : top.getClass()));
            }
            ...
            if (bottom instanceof Position) {
                ...
                fail("Tipo inesperado: " + (bottom == null ? "null" : bottom.getClass()));
            }
        }
        ...
        void getLeftRightMostPos() {
            ...
            if (left instanceof Position) {
                ...
                fail("Tipo inesperado: " + (left == null ? "null" : left.getClass()));
            }
            ...
            if (right instanceof Position) {
                ...
                fail("Tipo inesperado: " + (right == null ? "null" : right.getClass()));
            }
        }
    }

    @Nested
    @DisplayName("Testes de Proximidade e Texto")
    class MiscTests {
